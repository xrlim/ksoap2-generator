 ...
 *
 */
public final class JavaSoapClassGenerator extends AbstractGenerator {
     ...
     */
    public JavaSoapClassGenerator(HashMap<String, Class<?>> serviceClassesHM, final Class<?> clazz, Writer writer, final String generatedFolder) {
        super(serviceClassesHM, clazz, writer, generatedFolder);
        nameSpace = clazz.getPackage().getName() + ".soap.model";
    }
