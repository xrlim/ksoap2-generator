...
/**
 * Tests web services using 'boolean' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public class TestForBoolean extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForBoolean.wsdl", "-g", System.getProperty("user.dir")
