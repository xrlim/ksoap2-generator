...
/**
 * Tests web services using 'byte' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public class TestForByte extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForByte.wsdl", "-g", System.getProperty("user.dir")
