...
/**
 * Tests web services using 'float' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public final class TestForFloat extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForFloat.wsdl", "-g", System.getProperty("user.dir")
