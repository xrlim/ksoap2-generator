...
/**
 * Tests web services using 'int' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public final class TestForInt extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForInt.wsdl", "-g", System.getProperty("user.dir")
