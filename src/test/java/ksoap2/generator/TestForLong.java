...
/**
 * Tests web services using 'long' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public class TestForLong extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForLong.wsdl", "-g", System.getProperty("user.dir")
