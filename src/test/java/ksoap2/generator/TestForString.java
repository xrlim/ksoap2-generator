...
/**
 * Tests web services using 'String' for the parameter types or return type.
 * 
 * @author Cong Kinh Nguyen
 *
 */
public class TestForString extends AbstractTest {

    @Test
    public void generate() throws Exception {
        String [] args = new String[] {"-w", prefixPath + separatorChar
                + "ForString.wsdl", "-g", System.getProperty("user.dir")
